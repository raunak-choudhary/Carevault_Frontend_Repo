        ...
        <div className={styles.createContainer}>
          ...
          <div className={styles.createInfoSidebar}>
            ...
            <ul className={styles.infoList}>
              <li>
                <strong>Search Providers</strong> – Find healthcare providers
                near you
              </li>
              <li>
              ...
              <li>
                <strong>Set Reminder</strong> – Get notified before your
                appointment
              </li>
              <li>
                <strong>Easy Rescheduling</strong> – Change your appointment if
                needed
              </li>
            </ul>
            ...
            <div className={styles.infoNote}>
              ...
              <p>
                Appointments can be cancelled or rescheduled up to 24 hours
                before the scheduled time without any penalty.
              </p>
            </div>
          </div>
        </div>
