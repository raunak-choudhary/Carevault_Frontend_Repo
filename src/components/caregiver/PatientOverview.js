      ...
      {loading ? (
        ...
        <div className={styles.summaryGrid}>
          <div className={styles.summaryCard}>
            ...
            <div className={styles.cardContent}>
              <div className={styles.statValue}>
                {patientSummary.appointments.upcoming}
              </div>
              <div className={styles.statLabel}>Upcoming</div>
              {patientSummary.appointments.next && (
                <div className={styles.detailItem}>
                  <span>Next:</span> {patientSummary.appointments.next.date}{' '}
                  with {patientSummary.appointments.next.provider}
                </div>
              )}
            </div>
            <Link
              to={`${getBaseUrl()}/appointments`}
          ...
          <div className={styles.summaryCard}>
            ...
            <div className={styles.cardContent}>
              <div className={styles.statValue}>
                {patientSummary.medications.dueToday}
              </div>
              <div className={styles.statLabel}>Due Today</div>
              <div className={styles.detailItem}>
                <span>Total:</span> {patientSummary.medications.total}{' '}
                medications
              </div>
            </div>
            <Link
              to={`${getBaseUrl()}/medications`}
              className={styles.cardLink}
            >
          ...
          <div className={styles.summaryCard}>
            ...
            <div className={styles.cardContent}>
              <div className={styles.statValue}>
                {patientSummary.documents.total}
              </div>
              <div className={styles.statLabel}>Total Documents</div>
              {patientSummary.documents.recent && (
                <div className={styles.detailItem}>
                  <span>Recent:</span> {patientSummary.documents.recent.name} (
                  {patientSummary.documents.recent.date})
                </div>
              )}
            </div>
