...
const Sidebar = ({ isOpen, onClose }) => {
  ...
  const getBaseUrl = () => {
    return isViewingPatient && activePatient
    ...
    return [
      ...
      },
      {
        ...
        subItems: [
          ...
          {
            to: `${baseUrl}/appointments/create`,
            label: 'Schedule New',
            icon: <FiPlus size={14} />,
          },
          {
            to: `${baseUrl}/appointments/providers`,
      ...
      },
      {
        ...
        subItems: [
          ...
          {
            to: `${baseUrl}/medications/add`,
            label: 'Add Medication',
            icon: <FiPlus size={14} />,
          },
          {
            to: `${baseUrl}/medications/reminders`,
            label: 'Reminders',
            icon: <FiBell size={14} />,
          },
        ],
      },
      {
        ...
        subItems: [
          ...
          {
            to: `${baseUrl}/insights/metric/weight`,
            label: 'Weight',
            icon: <FiTrendingUp size={14} />,
          },
          {
            to: `${baseUrl}/insights/metric/bloodPressure`,
            label: 'Blood Pressure',
            icon: <FiActivity size={14} />,
          },
          {
            to: `${baseUrl}/insights/metric/bloodGlucose`,
            label: 'Blood Glucose',
            icon: <FiActivity size={14} />,
          },
          {
            to: `${baseUrl}/insights/metric/heartRate`,
            label: 'Heart Rate',
            icon: <FiHeart size={14} />,
          },
          {
            to: `${baseUrl}/insights/metric/sleep`,
            label: 'Sleep',
            icon: <FiActivity size={14} />,
          },
          {
            to: `${baseUrl}/insights/metric/steps`,
            label: 'Steps',
            icon: <FiActivity size={14} />,
          },
          {
            to: `${baseUrl}/insights/input`,
  ...
  const caregiverNavItems = [
    ...
    },
    {
      ...
      subItems: [
        ...
        {
          to: '/settings?section=caregiving',
          label: 'Caregiving',
          icon: <FiUser size={14} />,
        },
      ],
