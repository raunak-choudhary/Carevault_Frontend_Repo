      ...
      <div className={styles.projectInfo}>
        <div className={styles.projectMetadata}>
          ...
          <div className={styles.metadataItem}>
            ...
            <span className={styles.metadataValue}>Human-Computer Interaction (CS-GY 6543)</span>
          </div>
          <div className={styles.metadataItem}>
            <span className={styles.metadataLabel}>
        ...
        <div className={styles.projectDescription}>
          <p>
            CareVault is a comprehensive healthcare management platform designed as part of 
            the Human-Computer Interaction course at NYU. The project aims to solve the complex 
            challenges of healthcare management using artificial intelligence and a user-centered 
            design approach.
          </p>
        </div>
      </div>
