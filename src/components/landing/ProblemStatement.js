        ...
        {activeTab === 'architecture' && (
          ...
          >
            ...
            <p className={styles.architectureIntro}>
              CareVault implements a modern, scalable architecture designed for
              security, performance, and extensibility. The system combines
              dedicated frontend components with robust backend services and AI
              integration.
            </p>
              ...
              <div className={styles.architectureFeatures}>
                <div className={styles.architectureFeature}>
                  ...
                  <div className={styles.featureContent}>
                    ...
                    <p>
                      Clearly separated presentation, business logic, and data
                      layers ensure maintainability and testability.
                    </p>
                  </div>
                </div>
                ...
                <div className={styles.architectureFeature}>
                  ...
                  <div className={styles.featureContent}>
                    ...
                    <p>
                      HIPAA-compliant data management with end-to-end encryption
                      for all patient information.
                    </p>
                  </div>
                </div>
                ...
                <div className={styles.architectureFeature}>
                  ...
                  <div className={styles.featureContent}>
                    ...
                    <p>
                      Secure LLM integration with RAG architecture for advanced
                      document processing and intelligent insights.
                    </p>
                  </div>
                </div>
              </div>
